...
// Dimensione "influenza" del cristallo
...
void render() {
    ...
    for (int i = 0; i < GRID_SIZE; i++) 
    {
        for (int j = 0; j < GRID_SIZE; j++) 
        {
            ...
            {
                SDL_SetRenderDrawColor(renderer, 0, 255, 0, 255); // Colore cristallo
            }
...
int main(int argc, char *argv[])
{
    ...
    window = SDL_CreateWindow("Diffusion-Limited Aggregation (MT)",
